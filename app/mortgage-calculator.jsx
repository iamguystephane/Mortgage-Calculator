...
export default function MortgageCalculator() {
  ...
  return (
    <div className="main-container flex justify-center items-center min-h-screen bg-gray-100 p-4">
      <Card className="xsm:w-full md:w-2/3 h-[400px] flex flex-row items-center justify-center rounded-2xl rounded-tl-2xl rounded-bl-2x p-0 xsm:w-full xsm:h-[400px] main-card">
        <CardContent className="p-6 bg-white xsm:w-2/3 md:w-1/2 info-card rounded-2xl">
          <div className="flex justify-between">
            <h2 className="text-xl font-semibold">Mortgage Calculator</h2>
            <button className="text-sm text-blue-500 cursor-pointer" onClick={handleClear}>
              Clear All
            </button>
          </div>
          <div className="mt-4 space-y-4">
            ...
            <Button
              className="text-white bg-yellow-700 hover:bg-yellow-800 font-medium py-2 rounded-lg mt-4 w-1/2"
      ...
      <Card className="responsive-card xsm:w-full md:w-2/3 h-[400px] flex flex-row items-center justify-center rounded-2xl rounded-bl-2x p-0 xsm:w-full xsm:h-[400px]">
        <CardContent className="responsive-card-content p-0 !h-full bg-gray-900 rounded-2xl flex flex-col items-center justify-center px-5 xsm:hidden md:flex w-full">
          <h1 className="text-white text-lg"> Results show here </h1>
          <p className="text-center mt-2 text-gray-400">
            Complete the form and click on "complete payments" to see what
            monthly repayments would be.
